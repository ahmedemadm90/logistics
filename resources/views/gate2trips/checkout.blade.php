...
@section('content')
    <div class="card mt-2">
        <div class="card-body">
            <h2>{{ __('Trip Checkout') }} || {{__('Gate 2')}}</h2>
        </div>
        <div class="m-2">
            <a class="btn btn-success" href="{{route('gate2.indexout')}}">{{ __('الرجوع') }}</a>
        </div>
    </div>
    ...
    <div class="col-md-12 m-auto">
        <div class="card mt-2">
            <div class="card-body ">
                <form class="form" method="POST" action="{{ route('gate2.storeout') }}">
                    @csrf
